...
const tourBookingSignupSchema = z.object({
...
type TourBookingSignupFormValues = z.infer<typeof tourBookingSignupSchema>;

export function TourBookingSignup() {
  const t = useTranslations("vendorSignup");
  const router = useRouter();

  const form = useForm<TourBookingSignupFormValues>({
    resolver: zodResolver(tourBookingSignupSchema),
    defaultValues: {
      category: "",
      companyName: "",
      companyAddress: "",
                      ...
                      <FormControl>
                        ...
                        >
                          ...
                          <SelectContent className="bg-gray-100">
                            <SelectItem value="guidedTours">
                              {t("guidedTours")}
                            </SelectItem>
                            <SelectItem value="safaris">
                              {t("safaris")}
                            </SelectItem>
                            <SelectItem value="cityExplorations">
                              {t("cityExplorations")}
                            </SelectItem>
                            <SelectItem value="adventureExperiences">
                              {t("adventureExperiences")}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </FormControl>
