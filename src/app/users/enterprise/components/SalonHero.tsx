...
import responseTimeIcon from "../assets/response-time.png";

export const SalonHero = () => {
  const t = useTranslations("salonHero");
  const image =
        ...
        <div className="flex flex-row gap-3 mt-2">
          <Badge className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-full text-sm font-medium">
            <Image
              ...
              height={30}
            />
            {t("minimumOrderDay", { days: 1 })}
          </Badge>
          <Badge className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-full text-sm font-medium">
            <Image
              src={responseTimeIcon}
              alt={t("responseTimeIconAlt")}
              className="max-h-5 max-w-5"
              width={30}
              height={30}
            />
            {t("responseTime", { min: 20, max: 25 })}
          </Badge>
        </div>
