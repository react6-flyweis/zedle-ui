...
const suggestedCategories = [
  {
    ...
    rating: 5.0,
    image:
      "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=200&h=150&fit=crop&crop=center",
  ...
  },
  {
    ...
    rating: 4.9,
    image:
      "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=200&h=150&fit=crop&crop=center",
    description: "Famous volcano in Indonesia",
  },
  {
    id: 3,
    name: "Ahmad Stanton",
    rating: 5.0,
    image:
      "https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=200&h=150&fit=crop&crop=center",
    description: "Local guide",
  },
];

export default function TourTravelsSearchPage() {
