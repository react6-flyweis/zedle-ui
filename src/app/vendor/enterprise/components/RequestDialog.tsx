...
export function RequestDialog({
  request,
  children,
}: PropsWithChildren<{ request: IRequest }>) {
  const { name, email, phone, imageUrl, service, date, time, requestId } =
    request;
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-3xl max-h-[80vh] rounded-2xl p-0 overflow-y-auto">
        <Form {...form}>
          <form className="px-6 pb-8 pt-6" autoComplete="off">
            ...
            <div className="flex gap-4 mt-10">
              ...
              <Button
                type="button"
                className="flex-1 bg-black text-white font-semibold hover:bg-black/90"
              >
                {t("accept")}
              </Button>
            </div>
