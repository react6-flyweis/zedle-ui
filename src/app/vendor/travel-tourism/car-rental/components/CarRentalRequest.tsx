...
export function CarRentalRequest({ order }: { order: IOrder }) {
        ...
        <div className="relative z-10 h-full w-full flex flex-col justify-center space-y-4">
          <div className="top-8 left-0 w-full flex flex-col items-center">
            <div className="text-xl text-white text-center">
              {format(
                order.date,
                t("dateFormat", { defaultValue: "MMM dd, yyyy, hh:mm a" }),
              )}
          ...
          <div
            className={cn(
              "flex gap-3",
              order.status === "completed" ? "flex-col-reverse" : "flex-col",
            )}
          >
            {/* Details Section */}
            {order.status === "completed" && (
              <div className="px-8">
                <div className="grid grid-cols-2 border-y border-white/70/60 pt-4 pb-2 gap-x-4">
                  {/* Row 1 */}
                  <div className="flex flex-col items-start border-r border-white/70 pb-2 border-b">
                  ...
                  <div className="flex flex-col items-start pl-4 pb-2 border-b border-white/70">
                    <span className="text-xs text-white font-semibold tracking-wide">
                      {t("paymentMethod")}
                    </span>
                    <span className="text-white text-base">
                  ...
                  {/* Row 2 */}
                  <div className="flex flex-col items-start border-r border-white/70 pr-4 py-2 border-b">
                    <span className="text-xs text-white font-semibold tracking-wide">
                      {t("customerName")}
                    </span>
                    <span className="text-white text-base">{order.date}</span>
                  </div>
                  <div className="flex flex-col items-start pl-4 py-2 border-b border-white/70">
                    <span className="text-xs text-white font-semibold tracking-wide">
                      {t("shipmentStatus")}
                    </span>
                    <span className="text-white text-base">
                  ...
                  {/* Row 3 */}
                  <div className="flex flex-col items-start border-r border-white/70 pr-4 pt-2">
                    <span className="text-xs text-white font-semibold tracking-wide">
                      {t("customerName")}
                    </span>
                    <span className="text-white text-base">
            ...
            {order.status === "pending" && (
              <div className="px-8">
                <div className="grid grid-cols-2 border-y border-white/70/60 pt-4 pb-2 gap-x-4">
                  {/* Row 1 */}
                  <div className="flex flex-col items-start border-r border-white/70 pr-4 pb-2 border-b">
                    <span className="text-xs text-white font-semibold tracking-wide">
                      {t("itemsDimensions")}
                    </span>
                    <span className="text-white text-base">
